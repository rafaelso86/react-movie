...
export default class FilmesEmCartaz extends React.Component {
    ...
    componentDidMount() {
        axios.get('https://api.themoviedb.org/3/movie/now_playing?api_key=c5ff834a7a048ff4e4c1e1610a68fb47&language=pt-BR&page=1')
            .then(res => {
    ...
    render() {
        return (
            <React.Fragment>
                <Header
                    title="Filmes em cartaz | React Movies"
                    description="Filmes em cartaz em React Movies"
                    canonical="/filmes/em-cartaz"
                />
