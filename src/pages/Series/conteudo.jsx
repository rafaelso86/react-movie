...
export default class Conteudo extends React.Component{
    ...
    componentDidMount() {
        ...
        axios.get('https://api.themoviedb.org/3/tv/' + this.urlParams() + '?api_key=c5ff834a7a048ff4e4c1e1610a68fb47&language=pt-BR')
            .then(res => {
    ...
    render() {
        return (
            <React.Fragment>
                <Header
                    title={this.state.items.name + ' | React Movies'} 
